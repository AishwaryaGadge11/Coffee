...
const Navbar = () => {
  ...
  <div className='max-w-7xl mx-auto flex justify-between items-center py-2'>
   ...
   <h1 className='text-xl text-white font-sans ' style={{ fontFamily: 'Merienda' }}>Brew-crew</h1>
    </div>
   <nav className='md:flex hidden items-center gap-7'>
    <ul className='flex gap-7 items-center text-xl font-semibold text-white' style={{ fontFamily: 'Merienda' }}>
   ...
   {
    open ? <X 
   onClick={()=> setOpen(false)} className='text-white w-7 h-7 md:hidden'/> :
       <MenuIcon   onClick={()=> setOpen(true)}  className='text-white w-7 h-7 md:hidden'/>
   }
